...
var TokenEvents = {
  ItemCreated: {
    ...
    parseExtrinsic: async (extrinsic) => {
      genericExtrinsicSuccessProcessor(extrinsic);
      const events2 = extrinsic.groupedEvents?.common?.ItemCreated;
      if (!Array.isArray(events2) || !events2.length) {
        throw new EventNotFoundInExtrinsicError(extrinsic, "common.ItemCreated");
      }
      const collectionId = parseInt(events2[0]["0"], 10);
      const tokens = events2.map((event) => {
  ...
  FungibleItemsCreated: {
    ...
    parseExtrinsic: async (extrinsic) => {
      ...
      const { ["0"]: collectionId, ["2"]: owner, ["3"]: amount } = events2[0];
      return {
  ...
  ItemTransferred: {
    ...
    parseExtrinsic: async (extrinsic) => {
      genericExtrinsicSuccessProcessor(extrinsic);
      const events2 = extrinsic.groupedEvents?.common?.Transfer;
      if (!Array.isArray(events2) || !events2.length) {
  ...
  FungibleItemsTransferred: {
    ...
    parseExtrinsic: async (extrinsic) => {
      ...
      const { ["0"]: collectionId, ["2"]: from, ["3"]: to, ["4"]: amount } = events2[0];
      return {
        collectionId: parseInt(collectionId, 10),
  ...
  ItemDestroyed: {
    ...
    parseExtrinsic: async (extrinsic) => {
      genericExtrinsicSuccessProcessor(extrinsic);
      const events2 = extrinsic.groupedEvents?.common?.ItemDestroyed;
      if (!Array.isArray(events2) || !events2.length) {
  ...
  ItemPropertiesSet: {
    ...
    parseExtrinsic: async (extrinsic) => {
      genericExtrinsicSuccessProcessor(extrinsic);
      const events2 = extrinsic.groupedEvents?.common?.TokenPropertySet;
      if (!Array.isArray(events2) || !events2.length) {
        throw new EventNotFoundInExtrinsicError(extrinsic, "common.TokenPropertySet");
      }
      const collectionId = parseInt(events2[0]["0"], 10);
      const tokenId = parseInt(events2[0]["1"], 10);
      const keys = events2.map((event) => event["2"]);
      return {
        collectionId,
        tokenId,
        keys
  ...
  TokenPropertiesDeleted: {
    ...
    parseExtrinsic: async (extrinsic) => {
      genericExtrinsicSuccessProcessor(extrinsic);
      const events2 = extrinsic.groupedEvents?.common?.TokenPropertyDeleted;
      if (!Array.isArray(events2) || !events2.length) {
  ...
  TransferApproved: {
    ...
    parseExtrinsic: async (extrinsic) => {
      genericExtrinsicSuccessProcessor(extrinsic);
      const events2 = extrinsic.groupedEvents?.common?.Approved;
      if (!Array.isArray(events2) || !events2.length) {
        throw new EventNotFoundInExtrinsicError(extrinsic, "common.Approved");
      }
      const collectionId = parseInt(events2[0]["0"], 10);
      const tokenId = parseInt(events2[0]["1"], 10);
      const spender = import_address3.Address.extract.address(JSON.parse(events2[0]["3"]));
      const amount = parseInt(events2[0]["4"], 10);
...
var PalletNftsCollectionRoutesConfig = {
  queries: {
    getCollection,
    getCollectionsPaginated: getCollectionsPaginated2,
    getNextCollectionId
  },
  extrinsics: {
...
var PalletNftsItemRoutesConfig = {
  queries: {
    getItem
  },
  extrinsics: {
...
var PalletNftsAttributesRoutesConfig = {
  queries: {
    getAttribute,
    getAttributes
  },
...
var PalletNftsAccountRoutesConfig = {
  queries: {
...
var PalletNftsTradesRoutesConfig = {
  queries: {},
  extrinsics: {
    setPrice,
    buyItem
...
var PalletNftsUtilsRoutesConfig = {
  queries: {
    getTokenParsedMetadata: getTokenParsedMetadata2
  },
  extrinsics: {}
};
...
var AssetHubDerivativeCollectionsRoutesConfig = {
  queries: {
    getDerivativeRegistered: getDerivativeRegistered2
  },
  extrinsics: {
...
var PalletForeignAssetsAssetHubRoutesConfig = {
  queries: {
    getDerivativeRegistered: getDerivativeRegistered3,
    listDerivatives: listDerivatives2,
...
var uint8ArraySchema2 = import_zod50.z.string().regex(/^0x[a-fA-F0-9]+$/);
var zNetworkIdLiteral2 = import_zod50.z.enum(["polkadot", "kusama", "bitcoinCore", "bitcoinCash", "polkadotBulletin"]);
var zNetworkIdByGenesis2 = import_zod50.z.object({
  byGenesis: uint8ArraySchema2
});
var zNetworkId2 = import_zod50.z.union([zNetworkIdByGenesis2, zNetworkIdLiteral2]);
var zUniversalLocationObject2 = import_zod50.z.object({
  globalConsensus: zNetworkId2,
  parachain: import_zod50.z.number().optional(),
  palletInstance: import_zod50.z.number().optional(),
  generalIndex: import_zod50.z.number().optional()
});
var zTransferParams2 = import_zod50.z.object({
  senderAddress: import_zod50.z.string(),
  recipientAddress: import_zod50.z.string().optional(),
  itemId: import_zod50.z.number(),
  collectionUniversalLocation: zUniversalLocationObject2,
  sourceParachainId: import_zod50.z.number(),
  destinationParachainId: import_zod50.z.number()
});
var zFeeAsset2 = import_zod50.z.object({
...
var zXcmTransferResult = import_zod50.z.object({
  xcmMessageId: import_zod50.z.string(),
  xcmMessageHash: import_zod50.z.string()
});
var xcmMethods = {
  transferNft: {
  ...
  feeAssets: {
    ...
    schemaIn: import_zod50.z.object({
      parachainId: import_zod50.z.number()
    }),
    encodeSchemaIn: import_zod50.z.object({
      parachainId: import_zod50.z.number()
    }),
    schemaOut: import_zod50.z.array(zUniversalLocationObject2)
  }
};
...
var accounts = {
  zSingleAccountParams: import_zod51.z.object({
    address: import_zod51.z.string()
  }),
  zAccountRowSelect: import_zod51.z.object({
    address: import_zod51.z.string(),
    prototype: import_zod51.z.string().nullable(),
    mirror: import_zod51.z.string(),
    isEthereum: import_zod51.z.boolean(),
    isSigner: import_zod51.z.boolean().nullable(),
    isSmartContract: import_zod51.z.boolean().nullable(),
    createdAtBlockNumber: import_zod51.z.number(),
    updatedAtBlockNumber: import_zod51.z.number(),
    createdAt: import_zod51.z.coerce.date(),
    updatedAt: import_zod51.z.coerce.date()
  }),
  zAccountsFilter: import_zod51.z.object({
    addressIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    mirrorIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    isEthereum: import_zod51.z.boolean().optional(),
    isSigner: import_zod51.z.boolean().optional(),
    isSmartContract: import_zod51.z.boolean().optional(),
    createdTimestampFrom: import_zod51.z.coerce.date().optional(),
    createdTimestampTo: import_zod51.z.coerce.date().optional(),
    offset: import_zod51.z.number().default(0).optional(),
    limit: import_zod51.z.number().default(100).optional(),
    orderByAddress: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByCreatedTimestamp: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByCreatedAtBlockNumber: import_zod51.z.enum(["asc", "desc"]).optional()
  }),
  zAccountsWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
...
var blocks = {
  zSingleBlockParam: import_zod51.z.object({
    hashOrNumber: import_zod51.z.string()
  }),
  zBlockRowSelect: import_zod51.z.object({
    number: import_zod51.z.number(),
    hash: import_zod51.z.string(),
    parentHash: import_zod51.z.string(),
    specVersion: import_zod51.z.number(),
    timestamp: import_zod51.z.coerce.date(),
    relayParentNumber: import_zod51.z.number(),
    relayParentStorageRoot: import_zod51.z.string(),
    createdAt: import_zod51.z.coerce.date(),
    extrinsics: import_zod51.z.array(
      import_zod51.z.object({
        hash: import_zod51.z.string(),
        blockHash: import_zod51.z.string(),
        blockNumber: import_zod51.z.number(),
        indexInBlock: import_zod51.z.number(),
        signer: import_zod51.z.string(),
        section: import_zod51.z.string(),
        method: import_zod51.z.string(),
        args: import_zod51.z.record(import_zod51.z.any()),
        asHex: import_zod51.z.string(),
        createdAt: import_zod51.z.coerce.date(),
        events: import_zod51.z.array(
          import_zod51.z.object({
            extrinsicHash: import_zod51.z.string(),
            blockNumber: import_zod51.z.number(),
            section: import_zod51.z.string(),
            method: import_zod51.z.string(),
            data: import_zod51.z.record(import_zod51.z.any()),
            asHex: import_zod51.z.string(),
            createdAt: import_zod51.z.coerce.date()
          })
        ).default([]).optional()
  ...
  zBlocksFilter: import_zod51.z.object({
    numberFrom: import_zod51.z.number().optional(),
    numberTo: import_zod51.z.number().optional(),
    relayParentNumberFrom: import_zod51.z.number().optional(),
    relayParentNumberTo: import_zod51.z.number().optional(),
    timestampFrom: import_zod51.z.coerce.date().optional(),
    timestampTo: import_zod51.z.coerce.date().optional(),
    limit: import_zod51.z.number().default(100).optional(),
    offset: import_zod51.z.number().default(0).optional(),
    orderByNumber: import_zod51.z.enum(["asc", "desc"]).optional()
  }),
  zBlocksWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        number: import_zod51.z.number(),
        hash: import_zod51.z.string(),
...
var coinBalances = {
  zSingleCoinBalanceParam: import_zod51.z.object({
    address: import_zod51.z.string()
  }),
  zCoinBalanceRowSelect: import_zod51.z.object({
    address: import_zod51.z.string(),
    available: import_zod51.z.string(),
    locked: import_zod51.z.string(),
    free: import_zod51.z.string(),
    total: import_zod51.z.string(),
    reserved: import_zod51.z.string(),
    staked: import_zod51.z.string(),
    unstaked: import_zod51.z.string(),
    canstake: import_zod51.z.string(),
    createdAtBlockNumber: import_zod51.z.number(),
    updatedAtBlockNumber: import_zod51.z.number(),
    fetchedAtBlockNumber: import_zod51.z.number(),
    createdAt: import_zod51.z.coerce.date(),
    updatedAt: import_zod51.z.coerce.date()
  }),
  zCoinBalancesFilter: import_zod51.z.object({
    addressIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    offset: import_zod51.z.number().default(0).optional(),
    limit: import_zod51.z.number().default(100).optional(),
    availableFrom: import_zod51.z.bigint().optional(),
    availableTo: import_zod51.z.bigint().optional(),
    lockedFrom: import_zod51.z.bigint().optional(),
    lockedTo: import_zod51.z.bigint().optional(),
    freeFrom: import_zod51.z.bigint().optional(),
    freeTo: import_zod51.z.bigint().optional(),
    totalFrom: import_zod51.z.bigint().optional(),
    totalTo: import_zod51.z.bigint().optional(),
    reservedFrom: import_zod51.z.bigint().optional(),
    reservedTo: import_zod51.z.bigint().optional(),
    stakedFrom: import_zod51.z.bigint().optional(),
    stakedTo: import_zod51.z.bigint().optional(),
    unstakedFrom: import_zod51.z.bigint().optional(),
    unstakedTo: import_zod51.z.bigint().optional(),
    canstakeFrom: import_zod51.z.bigint().optional(),
    canstakeTo: import_zod51.z.bigint().optional(),
    orderByAddress: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByAvailable: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByLocked: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByFree: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByTotal: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByReserved: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByStaked: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByUnstaked: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByCanstake: import_zod51.z.enum(["asc", "desc"]).optional()
  }),
  zCoinBalancesWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        address: import_zod51.z.string(),
        available: import_zod51.z.string(),
...
var coinTransfers = {
  zCoinBalancesTransfersFilter: import_zod51.z.object({
    fromIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    toIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    amountFrom: import_zod51.z.bigint().optional(),
    amountTo: import_zod51.z.bigint().optional(),
    orderByFrom: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByTo: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByAmount: import_zod51.z.enum(["asc", "desc"]).optional(),
    offset: import_zod51.z.number().default(0).optional(),
    limit: import_zod51.z.number().default(100).optional()
  }),
  zCoinBalancesTransfersWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        id: import_zod51.z.number(),
        from: import_zod51.z.string(),
        to: import_zod51.z.string(),
        amount: import_zod51.z.string(),
        eventId: import_zod51.z.number(),
        event: import_zod51.z.object({
          blockNumber: import_zod51.z.number(),
          extrinsicHash: import_zod51.z.string(),
          extrinsic: import_zod51.z.object({
            indexInBlock: import_zod51.z.number(),
            section: import_zod51.z.string().optional(),
            method: import_zod51.z.string().optional(),
            signer: import_zod51.z.string().optional()
          })
        }).nullable()
      })
    ),
...
var collections = {
  zCollectionsFilter: import_zod51.z.object({
    mode: import_zod51.z.enum(["NFT", "Fungible", "RFT"]).optional(),
    collectionIdIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    nameLike: import_zod51.z.string().optional(),
    descriptionLike: import_zod51.z.string().optional(),
    ownerIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    adminIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    sponsorIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    isBurned: import_zod51.z.boolean().default(false).optional(),
    createdTimestampFrom: import_zod51.z.coerce.date().optional(),
    createdTimestampTo: import_zod51.z.coerce.date().optional(),
    updatedTimestampFrom: import_zod51.z.coerce.date().optional(),
    updatedTimestampTo: import_zod51.z.coerce.date().optional(),
    offset: import_zod51.z.number().default(0).optional(),
    limit: import_zod51.z.number().default(10).optional(),
    orderByCollectionId: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByName: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByDescription: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByOwner: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByUpdatedAtBlockNumber: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByCreatedAtBlockNumber: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByLastTokenId: import_zod51.z.enum(["asc", "desc"]).optional()
  }),
  zCollectionsWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        collectionId: import_zod51.z.number(),
        collectionAddress: import_zod51.z.string(),
        owner: import_zod51.z.string(),
        adminList: import_zod51.z.array(import_zod51.z.string()),
        mode: import_zod51.z.string(),
        fungiblePieces: import_zod51.z.number().nullable(),
        name: import_zod51.z.string(),
        description: import_zod51.z.string(),
        tokenPrefix: import_zod51.z.string(),
        sponsor: import_zod51.z.string().nullable(),
        isSponsorshipConfirmed: import_zod51.z.boolean().nullable(),
        lastTokenId: import_zod51.z.number(),
        limits: import_zod51.z.object({
          account_token_ownership_limit: import_zod51.z.number().nullable(),
          owner_can_destroy: import_zod51.z.boolean().nullable(),
          owner_can_transfer: import_zod51.z.boolean().nullable(),
          sponsor_approve_timeout: import_zod51.z.number().nullable(),
          sponsor_transfer_timeout: import_zod51.z.number().nullable(),
          sponsored_data_rate_limit: import_zod51.z.union([
            import_zod51.z.literal("SponsoringDisabled"),
            import_zod51.z.object({
              Blocks: import_zod51.z.number()
            })
          ]).nullable(),
          sponsored_data_size: import_zod51.z.number().nullable(),
          token_limit: import_zod51.z.number().nullable(),
          transfers_enabled: import_zod51.z.boolean().nullable()
        }),
        decodedLimits: import_zod51.z.record(
          import_zod51.z.object({
            key: import_zod51.z.string(),
            value: import_zod51.z.union([
              import_zod51.z.number(),
              import_zod51.z.boolean(),
              import_zod51.z.string(),
              import_zod51.z.object({
                Blocks: import_zod51.z.number()
              })
            ]),
            isDefaultValue: import_zod51.z.boolean()
          })
        ),
        permissions: import_zod51.z.object({
          access: import_zod51.z.union([import_zod51.z.literal("Normal"), import_zod51.z.literal("AllowList")]),
          mint_mode: import_zod51.z.boolean(),
          nesting: import_zod51.z.object({
            token_owner: import_zod51.z.boolean(),
            collection_admin: import_zod51.z.boolean(),
            restricted: import_zod51.z.union([import_zod51.z.null(), import_zod51.z.array(import_zod51.z.number())])
          })
        }),
        tokenPropertyPermissions: import_zod51.z.array(
          import_zod51.z.object({
            key: import_zod51.z.string(),
            keyHex: import_zod51.z.string(),
            permission: import_zod51.z.object({
              mutable: import_zod51.z.boolean(),
              collection_admin: import_zod51.z.boolean(),
              token_owner: import_zod51.z.boolean()
            })
          })
        ),
        properties: import_zod51.z.array(
          import_zod51.z.object({
            key: import_zod51.z.string(),
            keyHex: import_zod51.z.string(),
            value: import_zod51.z.string(),
            valueHex: import_zod51.z.string().optional()
          })
        ),
        propertiesMap: import_zod51.z.record(
          import_zod51.z.object({
            key: import_zod51.z.string(),
            keyHex: import_zod51.z.string(),
            value: import_zod51.z.string(),
        ...
        readOnly: import_zod51.z.boolean(),
        foreign: import_zod51.z.boolean().nullable(),
        erc721metadata: import_zod51.z.boolean().nullable(),
        schemaName: import_zod51.z.string().nullable(),
        schemaVersion: import_zod51.z.string().nullable(),
        originalSchemaVersion: import_zod51.z.string().nullable(),
        coverImage: import_zod51.z.object({
          url: import_zod51.z.string(),
          details: import_zod51.z.object({
            name: import_zod51.z.string().optional(),
            type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
            bytes: import_zod51.z.number().optional(),
            format: import_zod51.z.string().optional(),
            sha256: import_zod51.z.string().optional(),
            width: import_zod51.z.number().optional(),
            height: import_zod51.z.number().optional(),
            order: import_zod51.z.number().optional()
          }).optional(),
          thumbnail: import_zod51.z.object({
            url: import_zod51.z.string(),
            details: import_zod51.z.object({
              name: import_zod51.z.string().optional(),
              type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
        ...
        defaultTokenImage: import_zod51.z.object({
          url: import_zod51.z.string(),
          details: import_zod51.z.object({
            name: import_zod51.z.string().optional(),
            type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
        ...
        potentialAttributes: import_zod51.z.array(
          import_zod51.z.object({
            trait_type: import_zod51.z.string(),
            display_type: import_zod51.z.string().optional(),
            values: import_zod51.z.array(import_zod51.z.union([import_zod51.z.string(), import_zod51.z.number()])).optional()
          })
        ).optional().nullable(),
        customizingSlots: import_zod51.z.record(
          import_zod51.z.object({
            type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]),
            collections: import_zod51.z.array(import_zod51.z.union([import_zod51.z.number(), import_zod51.z.string()])).optional(),
            name: import_zod51.z.string().optional(),
            image_overlay_specs: import_zod51.z.object({
              layer: import_zod51.z.number().optional(),
              order_in_layer: import_zod51.z.number().optional(),
              offset: import_zod51.z.object({
                x: import_zod51.z.number().optional(),
                y: import_zod51.z.number().optional()
              }).optional(),
              opacity: import_zod51.z.number().optional(),
              rotation: import_zod51.z.number().optional(),
              scale: import_zod51.z.object({
                x: import_zod51.z.number().optional(),
                y: import_zod51.z.number().optional(),
                unit: import_zod51.z.enum(["px", "%"]).default("%").optional().optional()
              }).optional(),
              anchor_point: import_zod51.z.object({
                x: import_zod51.z.number(),
                y: import_zod51.z.number()
              }).optional(),
              parent_anchor_point: import_zod51.z.object({
                x: import_zod51.z.number(),
                y: import_zod51.z.number()
              }).optional()
            }).optional()
        ...
        customizes: import_zod51.z.array(import_zod51.z.union([import_zod51.z.number(), import_zod51.z.string()])).optional().nullable(),
        royalties: import_zod51.z.array(
          import_zod51.z.object({
            address: import_zod51.z.string(),
            percent: import_zod51.z.number(),
            isPrimaryOnly: import_zod51.z.boolean().optional()
          })
        ).optional().nullable(),
        collectionInfoError: import_zod51.z.string().nullable(),
        isBurned: import_zod51.z.boolean(),
        fetchedAtBlockNumber: import_zod51.z.number(),
        updatedAtBlockNumber: import_zod51.z.number(),
        updatedAt: import_zod51.z.coerce.date(),
        createdAt: import_zod51.z.coerce.date(),
  ...
  zParsedCollectionRowSelect: import_zod51.z.object({
    collectionId: import_zod51.z.number(),
    collectionAddress: import_zod51.z.string(),
    owner: import_zod51.z.string(),
    adminList: import_zod51.z.array(import_zod51.z.string()),
  ...
  zSingleCollectionParam: import_zod51.z.object({
    collectionId: import_zod51.z.string()
  })
};
var events = {
  zEventsFilter: import_zod51.z.object({
    sectionIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    methodIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    address: import_zod51.z.string().optional(),
    blockNumberFrom: import_zod51.z.number().optional(),
    blockNumberTo: import_zod51.z.number().optional(),
    limit: import_zod51.z.number().default(100).optional(),
    offset: import_zod51.z.number().default(0).optional(),
    orderByBlockNumber: import_zod51.z.enum(["asc", "desc"]).optional()
  }),
  zEventWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        extrinsicHash: import_zod51.z.string(),
        blockNumber: import_zod51.z.number(),
        blockTimestamp: import_zod51.z.number(),
        section: import_zod51.z.string(),
        method: import_zod51.z.string(),
        data: import_zod51.z.record(import_zod51.z.any()),
        asHex: import_zod51.z.string(),
  ...
  zSectionMethodArray: import_zod51.z.array(
    import_zod51.z.object({
      section: import_zod51.z.string(),
      method: import_zod51.z.string()
    })
...
var extrinsics = {
  zSingleExtrinsicParam: import_zod51.z.object({
    hash: import_zod51.z.string()
  }),
  zExtrinsicsFilter: import_zod51.z.object({
    sectionIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    methodIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    signerIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    blockNumberFrom: import_zod51.z.number().optional(),
    blockNumberTo: import_zod51.z.number().optional(),
    limit: import_zod51.z.number().default(100).optional(),
    offset: import_zod51.z.number().default(0).optional(),
    orderByBlockNumber: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByIndex: import_zod51.z.enum(["asc", "desc"]).optional()
  }),
  zExtrinsicRowSelect: import_zod51.z.object({
    hash: import_zod51.z.string(),
    blockHash: import_zod51.z.string(),
    blockNumber: import_zod51.z.number(),
    blockTimestamp: import_zod51.z.number(),
  ...
  zExtrinsicsWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        hash: import_zod51.z.string(),
        blockHash: import_zod51.z.string(),
...
var health = {
  zHealth: import_zod51.z.object({
    status: import_zod51.z.enum(["ok", "error"]),
    message: import_zod51.z.string().optional()
  })
};
var parsedNfts = {
  zParsedNftRowSelect: import_zod51.z.object({
    key: import_zod51.z.string(),
    collectionId: import_zod51.z.number(),
    tokenId: import_zod51.z.number(),
    collectionAddress: import_zod51.z.string(),
    tokenAddress: import_zod51.z.string(),
    owner: import_zod51.z.string(),
    topmostOwner: import_zod51.z.string().nullable(),
    isBundle: import_zod51.z.boolean(),
    properties: import_zod51.z.array(
      import_zod51.z.object({
        key: import_zod51.z.string(),
        keyHex: import_zod51.z.string(),
    ...
    schemaVersion: import_zod51.z.string().nullable(),
    originalSchemaVersion: import_zod51.z.string().nullable(),
    name: import_zod51.z.string().nullable(),
    description: import_zod51.z.string().nullable(),
    image: import_zod51.z.string().nullable(),
    imageDetails: import_zod51.z.object({
      name: import_zod51.z.string().optional(),
      type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
      bytes: import_zod51.z.number().optional(),
      format: import_zod51.z.string().optional(),
    ...
    attributes: import_zod51.z.array(
      import_zod51.z.object({
        trait_type: import_zod51.z.string(),
        value: import_zod51.z.union([import_zod51.z.string(), import_zod51.z.number()]),
        display_type: import_zod51.z.string().optional()
      })
    ).optional().nullable(),
    media: import_zod51.z.record(
      import_zod51.z.object({
        type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]),
        url: import_zod51.z.string(),
        name: import_zod51.z.string().optional(),
        details: import_zod51.z.object({
          ...
          height: import_zod51.z.number().optional(),
          order: import_zod51.z.number().optional(),
          duration: import_zod51.z.number().optional(),
          codecs: import_zod51.z.array(import_zod51.z.string()).optional(),
          loop: import_zod51.z.boolean().optional()
        }).optional(),
        thumbnail: import_zod51.z.object({
          url: import_zod51.z.string(),
          details: import_zod51.z.object({
    ...
    customizing: import_zod51.z.object({
      self: import_zod51.z.object({
        type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]),
        url: import_zod51.z.string(),
        name: import_zod51.z.string().optional(),
        details: import_zod51.z.object({
        ...
        placeholder: import_zod51.z.object({
          url: import_zod51.z.string(),
          details: import_zod51.z.object({
            name: import_zod51.z.string().optional(),
            type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
        ...
        tag: import_zod51.z.string()
      }),
      slots: import_zod51.z.record(
        import_zod51.z.object({
          type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]),
          collections: import_zod51.z.array(import_zod51.z.union([import_zod51.z.number(), import_zod51.z.string()])).optional(),
          name: import_zod51.z.string().optional(),
      ...
      mutator_reactions: import_zod51.z.record(
        import_zod51.z.object({
          layer: import_zod51.z.number().optional().optional(),
          order_in_layer: import_zod51.z.number().optional().optional(),
          offset: import_zod51.z.object({
            x: import_zod51.z.number().optional(),
            y: import_zod51.z.number().optional()
          }).optional().optional(),
          opacity: import_zod51.z.number().optional().optional(),
          rotation: import_zod51.z.number().optional().optional(),
          scale: import_zod51.z.object({
            x: import_zod51.z.number().optional(),
            y: import_zod51.z.number().optional(),
            unit: import_zod51.z.enum(["px", "%"]).default("%").optional().optional()
          ...
          url: import_zod51.z.string().optional(),
          details: import_zod51.z.object({
            name: import_zod51.z.string().optional(),
            type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
            bytes: import_zod51.z.number().optional(),
      ...
      mutators: import_zod51.z.array(import_zod51.z.string()).optional()
    }).optional().nullable(),
    customizingOverrides: import_zod51.z.object({
      self: import_zod51.z.object({
        type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
        url: import_zod51.z.string().optional(),
        name: import_zod51.z.string().optional().optional(),
        details: import_zod51.z.object({
          name: import_zod51.z.string().optional(),
          type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
          bytes: import_zod51.z.number().optional(),
        ...
        tag: import_zod51.z.string().optional()
      }).optional(),
      slots: import_zod51.z.record(
        import_zod51.z.object({
          type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
          collections: import_zod51.z.array(import_zod51.z.union([import_zod51.z.number(), import_zod51.z.string()])).optional().optional(),
          name: import_zod51.z.string().optional().optional(),
          image_overlay_specs: import_zod51.z.object({
            layer: import_zod51.z.number().optional(),
            order_in_layer: import_zod51.z.number().optional(),
      ...
      mutator_reactions: import_zod51.z.record(
        import_zod51.z.object({
          layer: import_zod51.z.number().optional().optional().optional(),
          order_in_layer: import_zod51.z.number().optional().optional().optional(),
          offset: import_zod51.z.object({
            x: import_zod51.z.number().optional(),
            y: import_zod51.z.number().optional()
          }).optional().optional().optional(),
          opacity: import_zod51.z.number().optional().optional().optional(),
          rotation: import_zod51.z.number().optional().optional().optional(),
          scale: import_zod51.z.object({
            x: import_zod51.z.number().optional(),
            y: import_zod51.z.number().optional(),
            unit: import_zod51.z.enum(["px", "%"]).default("%").optional().optional()
          ...
          url: import_zod51.z.string().optional().optional(),
          details: import_zod51.z.object({
            name: import_zod51.z.string().optional(),
            type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
            bytes: import_zod51.z.number().optional(),
    ...
    animationUrl: import_zod51.z.string().nullable(),
    animationDetails: import_zod51.z.object({
      name: import_zod51.z.string().optional(),
      type: import_zod51.z.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
      bytes: import_zod51.z.number().optional(),
      format: import_zod51.z.string().optional(),
    ...
    youtubeUrl: import_zod51.z.string().nullable(),
    createdBy: import_zod51.z.string().nullable(),
    backgroundColor: import_zod51.z.string().nullable(),
    externalUrl: import_zod51.z.string().nullable(),
    locale: import_zod51.z.string().nullable(),
    tokenInfoError: import_zod51.z.string().nullable(),
    isBurned: import_zod51.z.boolean(),
    fetchedAtBlockNumber: import_zod51.z.number(),
    updatedAtBlockNumber: import_zod51.z.number(),
    updatedAt: import_zod51.z.coerce.date(),
  ...
  zParsedNftsFilter: import_zod51.z.object({
    collectionIdIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    tokenIdIn: import_zod51.z.array(import_zod51.z.number()).optional(),
    ownerIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    topmostOwnerIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    royaltyRecipientIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    isBurned: import_zod51.z.boolean().optional(),
    isBundle: import_zod51.z.boolean().optional(),
    attributeValueIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    attributeTraitTypeIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    createdTimestampFrom: import_zod51.z.coerce.date().optional(),
    createdTimestampTo: import_zod51.z.coerce.date().optional(),
    updatedTimestampFrom: import_zod51.z.coerce.date().optional(),
    updatedTimestampTo: import_zod51.z.coerce.date().optional(),
    ...
    limit: import_zod51.z.number().default(10).optional(),
    orderByCollectionId: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByTokenId: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByCreatedAtBlockNumber: import_zod51.z.enum(["asc", "desc"]).optional(),
    orderByOwner: import_zod51.z.enum(["asc", "desc"]).optional()
  }),
  zParsedNftsWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        key: import_zod51.z.string(),
        collectionId: import_zod51.z.number(),
  ...
  zSingleParsedNftParam: import_zod51.z.object({
    collectionId: import_zod51.z.string(),
    tokenId: import_zod51.z.number()
  })
};
var tokenBalances = {
  zTokenBalancesFilter: import_zod51.z.object({
    addressIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    mode: import_zod51.z.enum(["NFT", "Fungible", "RFT"]).optional(),
    collectionIdIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    tokenIdIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    amountFrom: import_zod51.z.bigint().optional(),
    amountTo: import_zod51.z.bigint().optional(),
    offset: import_zod51.z.number().default(0).optional(),
    limit: import_zod51.z.number().default(100).optional(),
  ...
  zTokenBalancesWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        key: import_zod51.z.string(),
        address: import_zod51.z.string(),
...
var tokensTransfers = {
  zTokenBalancesTransfersFilter: import_zod51.z.object({
    fromIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    toIn: import_zod51.z.array(import_zod51.z.string()).optional(),
    mode: import_zod51.z.enum(["NFT", "Fungible", "RFT"]).optional(),
    collectionIdIn: import_zod51.z.array(import_zod51.z.string()).optional(),
  ...
  zTokenBalancesTransfersWithCount: import_zod51.z.object({
    items: import_zod51.z.array(
      import_zod51.z.object({
        id: import_zod51.z.number(),
        from: import_zod51.z.string(),
...
var ROUTES = {
  ...
  blocks: {
    single: { route: "/blocks/:hashOrNumber", schemaIn: import_zod52.z.object({ hashOrNumber: import_zod52.z.union([import_zod52.z.string(), import_zod52.z.number().int()]) }), schemaOut: blocks.zBlockRowSelect },
  ...
  events: {
    ...
    sections: { route: "/events/sections", schemaIn: import_zod52.z.never(), schemaOut: events.zSectionMethodArray }
  },
  extrinsics: {
    single: {
    ...
    sections: { route: "/extrinsics/sections", schemaIn: import_zod52.z.never(), schemaOut: events.zSectionMethodArray }
  },
  parsedNfts: {
    single: {
...
// src/assetsPallet.ts
var AssetsPalletRoutes = (options) => {
  const { makeQueryFn } = prepareBase(options);
  return {
    asset: {
      get: makeQueryFn(PalletAssetRoutesConfig.queries.getAsset),
      list: makeQueryFn(PalletAssetRoutesConfig.queries.getAssetsPaginated),
      balance: makeQueryFn(PalletAssetRoutesConfig.queries.getBalance)
    }
  };
};

// src/assetHub.ts
var AssetHub = (options) => {
  const { extrinsic, makeExtrinsicFn, makeQueryFn } = prepareBase(options);
  return {
    options,
    extrinsic,
    ...
    uniquesPallet: UniquesPalletRoutes(options),
    nftsPallet: NftsPalletRoutes(options),
    assetsPallet: AssetsPalletRoutes(options),
    derivative: {
      registered: makeQueryFn(AssetHubDerivativeCollectionsRoutesConfig.queries.getDerivativeRegistered),
      register: makeExtrinsicFn(AssetHubDerivativeCollectionsRoutesConfig.extrinsics.registerDerivative)
    },
    foreignAssets: {
      registered: makeQueryFn(PalletForeignAssetsAssetHubRoutesConfig.queries.getDerivativeRegistered),
      list: makeQueryFn(PalletForeignAssetsAssetHubRoutesConfig.queries.listDerivatives),
      accountBalance: makeQueryFn(PalletForeignAssetsAssetHubRoutesConfig.queries.getAccountBalance)
    },
    xcm: {
      transferNft: makeExtrinsicFn(xcmMethods.transferNft),
      transferFungible: makeExtrinsicFn(xcmMethods.transferFungible),
