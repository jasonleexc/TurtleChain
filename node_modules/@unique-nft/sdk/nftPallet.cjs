...
// src/nftsPallet.ts
var nftsPallet_exports = {};
__export(nftsPallet_exports, {
  NftsPalletRoutes: () => NftsPalletRoutes
});
module.exports = __toCommonJS(nftsPallet_exports);
...
//# sourceMappingURL=nftPallet.cjs.map