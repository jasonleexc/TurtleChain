...
var TokenEvents = {
  ...
  TransferApproved: {
    ...
    parseExtrinsic: async (extrinsic) => {
      ...
      const collectionId = parseInt(events2[0]["0"], 10);
      const tokenId = parseInt(events2[0]["1"], 10);
      const spender = Address3.extract.address(JSON.parse(events2[0]["3"]));
...
var accounts = {
  zSingleAccountParams: z51.object({
    address: z51.string()
  }),
  zAccountRowSelect: z51.object({
    address: z51.string(),
    prototype: z51.string().nullable(),
    mirror: z51.string(),
    isEthereum: z51.boolean(),
    isSigner: z51.boolean().nullable(),
    isSmartContract: z51.boolean().nullable(),
    createdAtBlockNumber: z51.number(),
    updatedAtBlockNumber: z51.number(),
    createdAt: z51.coerce.date(),
    updatedAt: z51.coerce.date()
  }),
  zAccountsFilter: z51.object({
    addressIn: z51.array(z51.string()).optional(),
    mirrorIn: z51.array(z51.string()).optional(),
    isEthereum: z51.boolean().optional(),
    isSigner: z51.boolean().optional(),
    isSmartContract: z51.boolean().optional(),
    createdTimestampFrom: z51.coerce.date().optional(),
    createdTimestampTo: z51.coerce.date().optional(),
    offset: z51.number().default(0).optional(),
    limit: z51.number().default(100).optional(),
    orderByAddress: z51.enum(["asc", "desc"]).optional(),
    orderByCreatedTimestamp: z51.enum(["asc", "desc"]).optional(),
    orderByCreatedAtBlockNumber: z51.enum(["asc", "desc"]).optional()
  }),
  zAccountsWithCount: z51.object({
    items: z51.array(
      z51.object({
        address: z51.string(),
        prototype: z51.string().nullable(),
...
var blocks = {
  zSingleBlockParam: z51.object({
    hashOrNumber: z51.string()
  }),
  zBlockRowSelect: z51.object({
    number: z51.number(),
    hash: z51.string(),
    parentHash: z51.string(),
    specVersion: z51.number(),
    timestamp: z51.coerce.date(),
    relayParentNumber: z51.number(),
    relayParentStorageRoot: z51.string(),
    createdAt: z51.coerce.date(),
    extrinsics: z51.array(
      z51.object({
        hash: z51.string(),
        blockHash: z51.string(),
        blockNumber: z51.number(),
        indexInBlock: z51.number(),
        signer: z51.string(),
        section: z51.string(),
        method: z51.string(),
        args: z51.record(z51.any()),
        asHex: z51.string(),
        createdAt: z51.coerce.date(),
        events: z51.array(
          z51.object({
            extrinsicHash: z51.string(),
            blockNumber: z51.number(),
            section: z51.string(),
            method: z51.string(),
            data: z51.record(z51.any()),
            asHex: z51.string(),
            createdAt: z51.coerce.date()
          })
        ).default([]).optional()
  ...
  zBlocksFilter: z51.object({
    numberFrom: z51.number().optional(),
    numberTo: z51.number().optional(),
    relayParentNumberFrom: z51.number().optional(),
    relayParentNumberTo: z51.number().optional(),
    timestampFrom: z51.coerce.date().optional(),
    timestampTo: z51.coerce.date().optional(),
    limit: z51.number().default(100).optional(),
    offset: z51.number().default(0).optional(),
    orderByNumber: z51.enum(["asc", "desc"]).optional()
  }),
  zBlocksWithCount: z51.object({
    items: z51.array(
      z51.object({
        number: z51.number(),
        hash: z51.string(),
...
var coinBalances = {
  zSingleCoinBalanceParam: z51.object({
    address: z51.string()
  }),
  zCoinBalanceRowSelect: z51.object({
    address: z51.string(),
    available: z51.string(),
    locked: z51.string(),
    free: z51.string(),
    total: z51.string(),
    reserved: z51.string(),
    ...
    createdAtBlockNumber: z51.number(),
    updatedAtBlockNumber: z51.number(),
    fetchedAtBlockNumber: z51.number(),
    createdAt: z51.coerce.date(),
    updatedAt: z51.coerce.date()
  }),
  zCoinBalancesFilter: z51.object({
    addressIn: z51.array(z51.string()).optional(),
    offset: z51.number().default(0).optional(),
    limit: z51.number().default(100).optional(),
    availableFrom: z51.bigint().optional(),
    availableTo: z51.bigint().optional(),
    lockedFrom: z51.bigint().optional(),
    lockedTo: z51.bigint().optional(),
    freeFrom: z51.bigint().optional(),
    freeTo: z51.bigint().optional(),
    totalFrom: z51.bigint().optional(),
    totalTo: z51.bigint().optional(),
    reservedFrom: z51.bigint().optional(),
    reservedTo: z51.bigint().optional(),
    stakedFrom: z51.bigint().optional(),
    stakedTo: z51.bigint().optional(),
    unstakedFrom: z51.bigint().optional(),
    unstakedTo: z51.bigint().optional(),
    canstakeFrom: z51.bigint().optional(),
    canstakeTo: z51.bigint().optional(),
    orderByAddress: z51.enum(["asc", "desc"]).optional(),
    orderByAvailable: z51.enum(["asc", "desc"]).optional(),
    orderByLocked: z51.enum(["asc", "desc"]).optional(),
    orderByFree: z51.enum(["asc", "desc"]).optional(),
    orderByTotal: z51.enum(["asc", "desc"]).optional(),
    orderByReserved: z51.enum(["asc", "desc"]).optional(),
    orderByStaked: z51.enum(["asc", "desc"]).optional(),
    orderByUnstaked: z51.enum(["asc", "desc"]).optional(),
    orderByCanstake: z51.enum(["asc", "desc"]).optional()
  }),
  zCoinBalancesWithCount: z51.object({
    items: z51.array(
      z51.object({
        address: z51.string(),
        available: z51.string(),
...
var coinTransfers = {
  zCoinBalancesTransfersFilter: z51.object({
    fromIn: z51.array(z51.string()).optional(),
    toIn: z51.array(z51.string()).optional(),
    amountFrom: z51.bigint().optional(),
    amountTo: z51.bigint().optional(),
    orderByFrom: z51.enum(["asc", "desc"]).optional(),
    orderByTo: z51.enum(["asc", "desc"]).optional(),
    orderByAmount: z51.enum(["asc", "desc"]).optional(),
    offset: z51.number().default(0).optional(),
    limit: z51.number().default(100).optional()
  }),
  zCoinBalancesTransfersWithCount: z51.object({
    items: z51.array(
      z51.object({
        id: z51.number(),
        from: z51.string(),
        ...
        event: z51.object({
          blockNumber: z51.number(),
          extrinsicHash: z51.string(),
          extrinsic: z51.object({
            indexInBlock: z51.number(),
            section: z51.string().optional(),
            method: z51.string().optional(),
            signer: z51.string().optional()
          })
        }).nullable()
      })
    ),
...
var collections = {
  zCollectionsFilter: z51.object({
    mode: z51.enum(["NFT", "Fungible", "RFT"]).optional(),
    collectionIdIn: z51.array(z51.string()).optional(),
    nameLike: z51.string().optional(),
    descriptionLike: z51.string().optional(),
    ownerIn: z51.array(z51.string()).optional(),
    adminIn: z51.array(z51.string()).optional(),
    sponsorIn: z51.array(z51.string()).optional(),
    isBurned: z51.boolean().default(false).optional(),
    createdTimestampFrom: z51.coerce.date().optional(),
    createdTimestampTo: z51.coerce.date().optional(),
    updatedTimestampFrom: z51.coerce.date().optional(),
    updatedTimestampTo: z51.coerce.date().optional(),
    offset: z51.number().default(0).optional(),
    limit: z51.number().default(10).optional(),
    orderByCollectionId: z51.enum(["asc", "desc"]).optional(),
    orderByName: z51.enum(["asc", "desc"]).optional(),
    orderByDescription: z51.enum(["asc", "desc"]).optional(),
    orderByOwner: z51.enum(["asc", "desc"]).optional(),
    orderByUpdatedAtBlockNumber: z51.enum(["asc", "desc"]).optional(),
    orderByCreatedAtBlockNumber: z51.enum(["asc", "desc"]).optional(),
    orderByLastTokenId: z51.enum(["asc", "desc"]).optional()
  }),
  zCollectionsWithCount: z51.object({
    items: z51.array(
      z51.object({
        collectionId: z51.number(),
        collectionAddress: z51.string(),
        owner: z51.string(),
        adminList: z51.array(z51.string()),
        mode: z51.string(),
        fungiblePieces: z51.number().nullable(),
        name: z51.string(),
        description: z51.string(),
        tokenPrefix: z51.string(),
        sponsor: z51.string().nullable(),
        isSponsorshipConfirmed: z51.boolean().nullable(),
        lastTokenId: z51.number(),
        limits: z51.object({
          account_token_ownership_limit: z51.number().nullable(),
          owner_can_destroy: z51.boolean().nullable(),
          owner_can_transfer: z51.boolean().nullable(),
          sponsor_approve_timeout: z51.number().nullable(),
          sponsor_transfer_timeout: z51.number().nullable(),
          sponsored_data_rate_limit: z51.union([
            z51.literal("SponsoringDisabled"),
            z51.object({
              Blocks: z51.number()
            })
          ]).nullable(),
          sponsored_data_size: z51.number().nullable(),
          token_limit: z51.number().nullable(),
          transfers_enabled: z51.boolean().nullable()
        }),
        decodedLimits: z51.record(
          z51.object({
            key: z51.string(),
            value: z51.union([
              z51.number(),
            ...
            isDefaultValue: z51.boolean()
          })
        ),
        permissions: z51.object({
          access: z51.union([z51.literal("Normal"), z51.literal("AllowList")]),
          mint_mode: z51.boolean(),
          nesting: z51.object({
            token_owner: z51.boolean(),
            collection_admin: z51.boolean(),
            restricted: z51.union([z51.null(), z51.array(z51.number())])
          })
        }),
        tokenPropertyPermissions: z51.array(
          z51.object({
            key: z51.string(),
            keyHex: z51.string(),
        ...
        properties: z51.array(
          z51.object({
            key: z51.string(),
            keyHex: z51.string(),
            value: z51.string(),
            valueHex: z51.string().optional()
          })
        ),
        propertiesMap: z51.record(
          z51.object({
            key: z51.string(),
            keyHex: z51.string(),
            value: z51.string(),
        ...
        readOnly: z51.boolean(),
        foreign: z51.boolean().nullable(),
        erc721metadata: z51.boolean().nullable(),
        schemaName: z51.string().nullable(),
        schemaVersion: z51.string().nullable(),
        originalSchemaVersion: z51.string().nullable(),
        coverImage: z51.object({
          url: z51.string(),
          details: z51.object({
            name: z51.string().optional(),
            type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
            bytes: z51.number().optional(),
            format: z51.string().optional(),
            sha256: z51.string().optional(),
            width: z51.number().optional(),
            height: z51.number().optional(),
            order: z51.number().optional()
          }).optional(),
          thumbnail: z51.object({
            url: z51.string(),
            details: z51.object({
              name: z51.string().optional(),
              type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
        ...
        potentialAttributes: z51.array(
          z51.object({
            trait_type: z51.string(),
            display_type: z51.string().optional(),
            values: z51.array(z51.union([z51.string(), z51.number()])).optional()
          })
        ).optional().nullable(),
        customizingSlots: z51.record(
          z51.object({
            type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]),
            collections: z51.array(z51.union([z51.number(), z51.string()])).optional(),
            name: z51.string().optional(),
            image_overlay_specs: z51.object({
              layer: z51.number().optional(),
              order_in_layer: z51.number().optional(),
              offset: z51.object({
                x: z51.number().optional(),
                y: z51.number().optional()
              }).optional(),
              opacity: z51.number().optional(),
              rotation: z51.number().optional(),
              scale: z51.object({
                x: z51.number().optional(),
                y: z51.number().optional(),
                unit: z51.enum(["px", "%"]).default("%").optional().optional()
              }).optional(),
              anchor_point: z51.object({
                x: z51.number(),
                y: z51.number()
              }).optional(),
              parent_anchor_point: z51.object({
                x: z51.number(),
                y: z51.number()
              }).optional()
            }).optional()
        ...
        customizes: z51.array(z51.union([z51.number(), z51.string()])).optional().nullable(),
        royalties: z51.array(
          z51.object({
            address: z51.string(),
            percent: z51.number(),
            isPrimaryOnly: z51.boolean().optional()
          })
        ).optional().nullable(),
        collectionInfoError: z51.string().nullable(),
        isBurned: z51.boolean(),
        fetchedAtBlockNumber: z51.number(),
        updatedAtBlockNumber: z51.number(),
        updatedAt: z51.coerce.date(),
        createdAt: z51.coerce.date(),
  ...
  zParsedCollectionRowSelect: z51.object({
    collectionId: z51.number(),
    collectionAddress: z51.string(),
    owner: z51.string(),
    adminList: z51.array(z51.string()),
  ...
  zSingleCollectionParam: z51.object({
    collectionId: z51.string()
  })
};
var events = {
  zEventsFilter: z51.object({
    sectionIn: z51.array(z51.string()).optional(),
    methodIn: z51.array(z51.string()).optional(),
    address: z51.string().optional(),
    blockNumberFrom: z51.number().optional(),
    blockNumberTo: z51.number().optional(),
    limit: z51.number().default(100).optional(),
    offset: z51.number().default(0).optional(),
    orderByBlockNumber: z51.enum(["asc", "desc"]).optional()
  }),
  zEventWithCount: z51.object({
    items: z51.array(
      z51.object({
        extrinsicHash: z51.string(),
        blockNumber: z51.number(),
        blockTimestamp: z51.number(),
        section: z51.string(),
        method: z51.string(),
        data: z51.record(z51.any()),
        asHex: z51.string(),
...
var extrinsics = {
  zSingleExtrinsicParam: z51.object({
    hash: z51.string()
  }),
  zExtrinsicsFilter: z51.object({
    sectionIn: z51.array(z51.string()).optional(),
    methodIn: z51.array(z51.string()).optional(),
    signerIn: z51.array(z51.string()).optional(),
    blockNumberFrom: z51.number().optional(),
    blockNumberTo: z51.number().optional(),
    limit: z51.number().default(100).optional(),
    offset: z51.number().default(0).optional(),
    orderByBlockNumber: z51.enum(["asc", "desc"]).optional(),
    orderByIndex: z51.enum(["asc", "desc"]).optional()
  }),
  zExtrinsicRowSelect: z51.object({
    hash: z51.string(),
    blockHash: z51.string(),
    blockNumber: z51.number(),
    blockTimestamp: z51.number(),
  ...
  zExtrinsicsWithCount: z51.object({
    items: z51.array(
      z51.object({
        hash: z51.string(),
        blockHash: z51.string(),
...
var health = {
  zHealth: z51.object({
    status: z51.enum(["ok", "error"]),
    message: z51.string().optional()
  })
};
var parsedNfts = {
  zParsedNftRowSelect: z51.object({
    key: z51.string(),
    collectionId: z51.number(),
    tokenId: z51.number(),
    collectionAddress: z51.string(),
    tokenAddress: z51.string(),
    owner: z51.string(),
    topmostOwner: z51.string().nullable(),
    isBundle: z51.boolean(),
    properties: z51.array(
      z51.object({
        key: z51.string(),
        keyHex: z51.string(),
    ...
    schemaVersion: z51.string().nullable(),
    originalSchemaVersion: z51.string().nullable(),
    name: z51.string().nullable(),
    description: z51.string().nullable(),
    image: z51.string().nullable(),
    imageDetails: z51.object({
      name: z51.string().optional(),
      type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
      bytes: z51.number().optional(),
      format: z51.string().optional(),
    ...
    attributes: z51.array(
      z51.object({
        trait_type: z51.string(),
        value: z51.union([z51.string(), z51.number()]),
        display_type: z51.string().optional()
      })
    ).optional().nullable(),
    media: z51.record(
      z51.object({
        ...
        details: z51.object({
          ...
          height: z51.number().optional(),
          order: z51.number().optional(),
          duration: z51.number().optional(),
          codecs: z51.array(z51.string()).optional(),
          loop: z51.boolean().optional()
        }).optional(),
        thumbnail: z51.object({
          url: z51.string(),
          details: z51.object({
    ...
    customizing: z51.object({
      ...
      mutator_reactions: z51.record(
        z51.object({
          layer: z51.number().optional().optional(),
          order_in_layer: z51.number().optional().optional(),
          offset: z51.object({
            x: z51.number().optional(),
            y: z51.number().optional()
          }).optional().optional(),
          opacity: z51.number().optional().optional(),
          rotation: z51.number().optional().optional(),
          scale: z51.object({
            x: z51.number().optional(),
            y: z51.number().optional(),
            unit: z51.enum(["px", "%"]).default("%").optional().optional()
      ...
      mutators: z51.array(z51.string()).optional()
    }).optional().nullable(),
    customizingOverrides: z51.object({
      self: z51.object({
        type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
        url: z51.string().optional(),
        name: z51.string().optional().optional(),
        details: z51.object({
          name: z51.string().optional(),
          type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
          bytes: z51.number().optional(),
        ...
        tag: z51.string().optional()
      }).optional(),
      slots: z51.record(
        z51.object({
          type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
          collections: z51.array(z51.union([z51.number(), z51.string()])).optional().optional(),
          name: z51.string().optional().optional(),
          image_overlay_specs: z51.object({
            layer: z51.number().optional(),
            order_in_layer: z51.number().optional(),
      ...
      mutator_reactions: z51.record(
        z51.object({
          layer: z51.number().optional().optional().optional(),
          order_in_layer: z51.number().optional().optional().optional(),
          offset: z51.object({
            x: z51.number().optional(),
            y: z51.number().optional()
          }).optional().optional().optional(),
          opacity: z51.number().optional().optional().optional(),
          rotation: z51.number().optional().optional().optional(),
          scale: z51.object({
            x: z51.number().optional(),
            y: z51.number().optional(),
            unit: z51.enum(["px", "%"]).default("%").optional().optional()
          ...
          url: z51.string().optional().optional(),
          details: z51.object({
            name: z51.string().optional(),
            type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
            bytes: z51.number().optional(),
    ...
    animationUrl: z51.string().nullable(),
    animationDetails: z51.object({
      name: z51.string().optional(),
      type: z51.enum(["image", "animation", "video", "audio", "spatial", "pdf", "document", "other"]).optional(),
      bytes: z51.number().optional(),
      format: z51.string().optional(),
    ...
    youtubeUrl: z51.string().nullable(),
    createdBy: z51.string().nullable(),
    backgroundColor: z51.string().nullable(),
    externalUrl: z51.string().nullable(),
    locale: z51.string().nullable(),
    tokenInfoError: z51.string().nullable(),
    isBurned: z51.boolean(),
    fetchedAtBlockNumber: z51.number(),
    updatedAtBlockNumber: z51.number(),
    updatedAt: z51.coerce.date(),
  ...
  zParsedNftsFilter: z51.object({
    collectionIdIn: z51.array(z51.string()).optional(),
    tokenIdIn: z51.array(z51.number()).optional(),
    ownerIn: z51.array(z51.string()).optional(),
    topmostOwnerIn: z51.array(z51.string()).optional(),
    royaltyRecipientIn: z51.array(z51.string()).optional(),
    isBurned: z51.boolean().optional(),
    isBundle: z51.boolean().optional(),
    attributeValueIn: z51.array(z51.string()).optional(),
    attributeTraitTypeIn: z51.array(z51.string()).optional(),
    createdTimestampFrom: z51.coerce.date().optional(),
    createdTimestampTo: z51.coerce.date().optional(),
    updatedTimestampFrom: z51.coerce.date().optional(),
    updatedTimestampTo: z51.coerce.date().optional(),
    ...
    limit: z51.number().default(10).optional(),
    orderByCollectionId: z51.enum(["asc", "desc"]).optional(),
    orderByTokenId: z51.enum(["asc", "desc"]).optional(),
    orderByCreatedAtBlockNumber: z51.enum(["asc", "desc"]).optional(),
    orderByOwner: z51.enum(["asc", "desc"]).optional()
  }),
  zParsedNftsWithCount: z51.object({
    items: z51.array(
      z51.object({
        key: z51.string(),
        collectionId: z51.number(),
  ...
  zSingleParsedNftParam: z51.object({
    collectionId: z51.string(),
    tokenId: z51.number()
  })
};
var tokenBalances = {
  zTokenBalancesFilter: z51.object({
    addressIn: z51.array(z51.string()).optional(),
    mode: z51.enum(["NFT", "Fungible", "RFT"]).optional(),
    collectionIdIn: z51.array(z51.string()).optional(),
    tokenIdIn: z51.array(z51.string()).optional(),
    amountFrom: z51.bigint().optional(),
    amountTo: z51.bigint().optional(),
    offset: z51.number().default(0).optional(),
    limit: z51.number().default(100).optional(),
  ...
  zTokenBalancesWithCount: z51.object({
    items: z51.array(
      z51.object({
        key: z51.string(),
        address: z51.string(),
...
var tokensTransfers = {
  zTokenBalancesTransfersFilter: z51.object({
    fromIn: z51.array(z51.string()).optional(),
    toIn: z51.array(z51.string()).optional(),
    mode: z51.enum(["NFT", "Fungible", "RFT"]).optional(),
    collectionIdIn: z51.array(z51.string()).optional(),
  ...
  zTokenBalancesTransfersWithCount: z51.object({
    items: z51.array(
      z51.object({
        id: z51.number(),
        from: z51.string(),
...
var ROUTES = {
  ...
  blocks: {
    single: { route: "/blocks/:hashOrNumber", schemaIn: z52.object({ hashOrNumber: z52.union([z52.string(), z52.number().int()]) }), schemaOut: blocks.zBlockRowSelect },
  ...
  events: {
    ...
    sections: { route: "/events/sections", schemaIn: z52.never(), schemaOut: events.zSectionMethodArray }
  },
  extrinsics: {
    single: {
    ...
    sections: { route: "/extrinsics/sections", schemaIn: z52.never(), schemaOut: events.zSectionMethodArray }
  },
  parsedNfts: {
    single: {
